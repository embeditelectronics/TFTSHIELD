...
#define BS_UDB_0_4_0_CONFIG_VAL ((const uint8 CYFAR *)(0x4800029Cu + CYAPP_ECC_OFFSET))

/* IOPINS0_7 Address: CYREG_PRT12_DM0 Size (bytes): 8 */
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)(0x4800031Cu + CYAPP_ECC_OFFSET))

/* IOPINS0_6 Address: CYREG_PRT6_DR Size (bytes): 10 */
#define BS_IOPINS0_6_VAL ((const uint8 CYFAR *)(0x48000324u + CYAPP_ECC_OFFSET))
