...
#define cy_cfg_data_table ((const cy_cfg_addrvalue_t CYFAR *)(0x48000040u + CYAPP_ECC_OFFSET))

/* UDB_0_4_0_CONFIG Address: CYDEV_UCFG_B0_P6_U1_BASE Size (bytes): 128 */
#define BS_UDB_0_4_0_CONFIG_VAL ((const uint8 CYFAR *)(0x480001FCu + CYAPP_ECC_OFFSET))

/* IOPINS0_7 Address: CYREG_PRT12_DM0 Size (bytes): 8 */
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)(0x4800027Cu + CYAPP_ECC_OFFSET))

/* IOPINS0_6 Address: CYREG_PRT6_DR Size (bytes): 10 */
#define BS_IOPINS0_6_VAL ((const uint8 CYFAR *)(0x48000284u + CYAPP_ECC_OFFSET))
