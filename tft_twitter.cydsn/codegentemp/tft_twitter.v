// ======================================================================
// tft_twitter.v generated from TopDesign.cysch
// 08/19/2014 at 23:23
...
module top ;
	...
	wire [0:0] tmpOE__bck_net;
	wire [0:0] tmpFB_0__bck_net;
	wire [0:0] tmpIO_0__bck_net;
	wire [0:0] tmpINTERRUPT_0__bck_net;
	electrical [0:0] tmpSIOVREF__bck_net;
	...
	cy_psoc3_pins_v1_10
		...
		bck
		 (.oe(tmpOE__bck_net),
		  .y({Net_9}),
		  .fb({tmpFB_0__bck_net[0:0]}),
		  .io({tmpIO_0__bck_net[0:0]}),
		  .siovref(tmpSIOVREF__bck_net),
		  .interrupt({tmpINTERRUPT_0__bck_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__bck_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
